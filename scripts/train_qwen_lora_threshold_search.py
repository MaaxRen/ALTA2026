#!/usr/bin/env python3
"""Qwen 0.6B baseline with validation-tuned sarcasm thresholds by variety."""
...
SETTINGS = QwenLoraExperimentSettings(
    ...
    output_dir=REPO_ROOT / "model_checkpoints" / "qwen_embedding_0.6b_multitask_lora_threshold_search",
    summary_dir=REPO_ROOT / "training_summary" / "runs" / "qwen_embedding_0.6b_multitask_lora_threshold_search",
    split_seeds=(2026, 2027, 2028, 2029, 2030),
    method="qwen_0.6b_lora_baseline_threshold_search",
