#!/usr/bin/env python3
"""Group DRO LoRA training for Qwen3-Embedding-8B with linear heads."""
...
SETTINGS = QwenLoraExperimentSettings(
    ...
    output_dir=REPO_ROOT / "model_checkpoints" / "qwen_embedding_8b_lora_group_dro",
    summary_dir=REPO_ROOT / "training_summary" / "runs" / "qwen_embedding_8b_lora_group_dro",
    split_seeds=(2026, 2027, 2028, 2029, 2030),
    method="qwen8b_lora_all_linear_group_dro",
