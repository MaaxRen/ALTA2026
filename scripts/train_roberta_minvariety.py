#!/usr/bin/env python3
"""Fully fine-tune RoBERTa for the BESSTIE minimum-variety score."""
...
OUTPUT_DIR = REPO_ROOT / "model_checkpoints" / "roberta_minvariety"
TRAINING_SUMMARY_DIR = REPO_ROOT / "training_summary" / "runs" / "roberta_minvariety"
...
def main() -> None:
    ...
    for split_seed in SPLIT_SEEDS:
        print(f"\n=== RoBERTa minimum-variety split seed {split_seed} ===")
        ...
        all_results[str(split_seed)] = run_training(
            config, tokenizer, model_factory, method="full_finetuning_minvariety"
        )
        gc.collect()
    ...
    print("\n=== RoBERTa minimum-variety results across splits ===")
